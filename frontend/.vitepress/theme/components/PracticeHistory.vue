...
function viewDetail(sessionId) {
  window.location.href = `/practice/online/?historySessionId=${sessionId}`
}
...
<style scoped>
.practice-history { max-width: 900px; margin: 0 auto; padding: 20px; }
...
.summary-card {
  ...
  gap: 16px; margin-bottom: 24px; background: var(--vp-c-bg-soft);
